...
**_ Lien https pour cloner le depot _**
    ...
    https://github.com/Junior-835/Labyrinthe_Groupe2_Project -> le lien vers le depot dans le navigateur

    # Ouvrir votre terminal windows

    # git clone https://github.com/Junior-835/Labyrinthe_Groupe2_Project.git -> pour cloner le projet
